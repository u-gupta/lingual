			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-dict">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="#" class="active" id="dict-form-link">Insert into Dictionary</a>
							</div>
							<div class="col-xs-6">
								<a href="#" id="quiz-form-link">Insert into Quiz Directory</a>
							</div>
						</div>
						<hr>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="dict-form" action="<?php echo base_url(); ?>index.php/chat/save_entry" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="word" id="word" tabindex="1" class="form-control" placeholder="Enter the Word" value="">
									</div>
									<div class="form-group">
										<input type="text" name="meaning" id="meaning" tabindex="2" class="form-control" placeholder="Enter its Meaning" value="">
									</div>
									<div class="form-group">
										<input type="text" name="pronunciation" id="pronunciation" tabindex="3" class="form-control" placeholder="Enter its Pronunciation" value="">
									</div>
									<div class="form-group">
										<input type="text" name="sentence" id="sentence" tabindex="4" class="form-control" placeholder="Enter a Sentence using the Word">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="submit" id="dict-submit" tabindex="5" class="form-control btn btn-dict" value="Insert">
											</div>
										</div>
									</div>>
								</form>
								<form id="quiz-form" action="<?php echo base_url(); ?>index.php/chat/save_quiz_entry" method="post" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="ques" id="ques" tabindex="1" class="form-control" placeholder="Question" value="">
									</div>
									<div class="form-group">
										<input type="text" name="correct_ans" id="correct_ans" tabindex="2" class="form-control" placeholder="Answer" value="">
									</div>
									<div class="form-group">
										<input type="text" name="option_a" id="option_a" tabindex="3" class="form-control" placeholder="Option A" value="">
									</div>
									<div class="form-group">
										<input type="text" name="option_b" id="option_b" tabindex="4" class="form-control" placeholder="Option B" value="">
									</div>
									<div class="form-group">
										<input type="text" name="option_c" id="option_c" tabindex="5" class="form-control" placeholder="Option C">
									</div>
									<div class="form-group">
										<input type="text" name="explanation" id="explanation" tabindex="5" class="form-control" placeholder="Explanation">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
